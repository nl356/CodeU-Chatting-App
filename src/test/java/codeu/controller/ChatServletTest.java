...
public class ChatServletTest {
  ...
  public void testDoPost_StoresMessage() throws IOException, ServletException {
    ...
    Assert.assertEquals("<p>Test message.</p>", messageArgumentCaptor.getValue().getContent());
  ...
  public void testDoPost_CleansHtmlContent() throws IOException, ServletException {
    ...
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals(
        "<p>Contains <b>html</b> and content.</p>", messageArgumentCaptor.getValue().getContent());
